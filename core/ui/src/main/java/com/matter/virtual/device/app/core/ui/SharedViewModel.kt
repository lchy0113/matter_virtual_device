...
import com.matter.virtual.device.app.core.common.event.Event
...
constructor(private val resetMatterAppUseCase: ResetMatterAppUseCase) : ViewModel() {
  ...
  private val _closeBusyLoop = MutableLiveData(false)
  val closeBusyLoop: LiveData<Boolean>
    get() = _closeBusyLoop
  ...
  fun stopBusyLoop(from: String) {
    Timber.d("Close Busy Loop from: $from")
    _closeBusyLoop.value = true
  }
}
